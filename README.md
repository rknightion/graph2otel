...
> registry currently contains **170 logical collectors** across Entra ID, Intune,
...
The repository also ships 1 dashboard, 17 alert rules, and 11 paused detection examples,
