...
**1 dashboard, 19 alert rules, and 11 paused detection examples**:
...
| `alerts/rules/` | 19 alert rules (**generated**) | Grafana **App Platform** `AlertRule` (`rules.alerting.grafana.app/v0alpha1`) | `graph2otel` |
