...
The generated registry currently exposes **170 logical collectors** through
...
contains 173 registration-path candidates because some logical collectors can register
