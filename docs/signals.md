...
The generated registry currently exposes **160 logical collectors** through
...
contains 163 registration-path candidates because some logical collectors can register
